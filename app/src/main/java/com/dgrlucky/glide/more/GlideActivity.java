package com.dgrlucky.glide.more;
...
import com.dgrlucky.glide.R;
import com.dgrlucky.glide.more.about.AboutActivity;
import com.dgrlucky.glide.more.image.SingleImageActivity;
...
public class GlideActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image31.setOnClickListener(v -> {
            Intent intent = new Intent(GlideActivity.this, SingleImageActivity.class);
            ...
            ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(GlideActivity.this, image31, getString(R.string.transitional_image));
            ActivityCompat.startActivity(GlideActivity.this, intent, compat.toBundle());
        });
        ...
        image32.setOnClickListener(v -> {
            ...
            ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(GlideActivity.this, image32, getString(R.string.transitional_image));
            ActivityCompat.startActivity(GlideActivity.this, intent, compat.toBundle());
        });
...
//            Log.d("--->", "load percentage: " + percentage + " totalBytes: " + totalBytes + " bytesRead: " + bytesRead);
    ...
    private void line4() {
        ...
        image41.setOnClickListener(v -> {
            ...
            ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(GlideActivity.this, image41, getString(R.string.transitional_image));
            ActivityCompat.startActivity(GlideActivity.this, intent, compat.toBundle());
        });
    }
