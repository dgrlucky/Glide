package com.dgrlucky.extension;
...
import com.dgrlucky.extension.more.OkHttpGlideUrlLoader;
import com.dgrlucky.extension.more.ProgressInterceptor;
...
public class GlideConfiguration extends AppGlideModule {
    ...
    public static void forget(String url) {
        GlideConfiguration.DispatchingProgressListener.forget(url);
    }

    public static void expect(String url, GlideConfiguration.UIonProgressListener listener) {
        GlideConfiguration.DispatchingProgressListener.expect(url, listener);
    }
    ...
    private static class DispatchingProgressListener implements GlideConfiguration
            .ResponseProgressListener {
        private static final WeakHashMap<String, UIonProgressListener> LISTENERS = new
                WeakHashMap<>();
